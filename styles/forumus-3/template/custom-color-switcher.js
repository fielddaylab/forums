(function ($) {
    ...
    $.cColorSwitcher = function(params) {
        ...
        // Switcher body
        $('<div class="ccs--body"><h6 style="margin: 0; font-size: 16px; line-height: 24px;">'+ params.switcherTitle  +'</h6><ul style="margin: 0; padding: 0; list-style: none; overflow: hidden"></ul><h6 style="margin: 14px 0 0; font-size: 16px; line-height: 24px;">Style 2 Colors:</h6><ul style="margin: 0; padding: 0; list-style: none; overflow: hidden"></ul><h6 style="margin: 14px 0 0; font-size: 16px; line-height: 24px;">Header Styles:</h6><a href="../default-version/"><img src="http://themelooks.com/demo/forumus/v01.png" style="width: 100%;">Default</a><a href="../transparent-version/"><img src="http://themelooks.com/demo/forumus/v02.png" style="width: 100%;">Transparent</a><a href="../semi-transparent-version/"><img src="http://themelooks.com/demo/forumus/v03.png" style="width: 100%;">Semi Transparent</a><a href="../theme-color-version/"><img src="http://themelooks.com/demo/forumus/v04.png" style="width: 100%;">Theme Color</a><a href="../simple-header-version/"><img src="http://themelooks.com/demo/forumus/v05.png" style="width: 100%;">Simple Header</a></div>')
            .css({
                'width': '250px',
